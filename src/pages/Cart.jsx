...
export default function Cart() {
  ...
  const onRemovePizza = (obj) => {
    dispatch(removePizza(obj));
  };

  const onPlusPizza = (obj) => {
    dispatch(plusPizza(obj));
  };
          ...
          <>
            ...
            <div className="content__items">
              {Object.keys(cart.items).map((key, idx) => {
                return (
                  <CartItem
                    key={idx}
                    pizza={cart.items[key][0]}
                    totalCount={cart.items[key].length}
                    totalPrice={cart.items[key].reduce(
            ...
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                ...
                <span>
                  Сумма заказа: <b>{cart.totalPrice} сум</b>
                </span>
              </div>
